...
const Toast = ({ title, message, isOpen, setIsOpen }: ToastProps) => {
    return (
        ...
        <div id="toast-default" className="flex items-center p-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
