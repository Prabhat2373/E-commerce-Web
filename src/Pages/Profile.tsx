...
import { useGetCurrentUserQuery } from '../Services/rtk/services/Api';
                ...
                <div className="space-y-6 bg-white px-4 py-5 sm:p-6">
                  ...
                  <div>
                    ...
                    <div className="mt-1 flex ">
                      <p className="mt-2">{user?.isSeller ? "Seller" : "User" ?? "N.A."}</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="overflow-hidden shadow sm:rounded-md">
                <div className="bg-white px-4 py-5 sm:p-6">
                  <div className="grid grid-cols-6 gap-6">
                    ...
                    <div className="col-span-6 sm:col-span-3">
                      <label htmlFor="country" className="block text-sm font-medium text-gray-700">
                        {user?.isSeller ? "Switch to User Mode?" : "Switch To Seller Mode?" ?? "N.A"}
                      </label>
                      <label className="inline-flex relative items-center cursor-pointer">
                        <input type="checkbox" className="sr-only peer " checked={!!userMode} onChange={() => setUserMode(!userMode)} />
                        <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                        <span className="ml-3 text-sm text-gray-900 font-semibold">{user?.isSeller ? "Seller Mode" : "User Mode" ??
                          "N.A"}</span>
                      </label>
                    </div>
